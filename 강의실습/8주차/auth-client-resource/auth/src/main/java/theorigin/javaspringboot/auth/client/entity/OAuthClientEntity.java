package theorigin.javaspringboot.auth.client.entity;

import theorigin.javaspringboot.auth.entity.BaseEntity;
...
public class OAuthClientEntity extends BaseEntity {
    ...
    public OAuthClientEntity(Long id, String uid, String clientId, String clientSecret, List<RedirectEntity> redirectUris) {
        this.id = id;
        this.uid = uid;
