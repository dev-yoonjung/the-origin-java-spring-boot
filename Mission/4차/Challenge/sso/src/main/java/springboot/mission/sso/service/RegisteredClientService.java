...
import springboot.mission.sso.repository.ClientRepository;
import springboot.mission.sso.repository.RedirectRepository;
...
public class RegisteredClientService implements RegisteredClientRepository {
    ...
    public RegisteredClientService(@Autowired ClientRepository clientRepository,
        ...
        RedirectEntity redirectEntity1 = new RedirectEntity(
                newClient,
                "http://127.0.0.1:8080/login/oauth2/code/likelion-oidc"
        );
